...
public class AutonLRS extends CommandGroup {
	public AutonLRS(){
		...
		addSequential(new MakeParallel(
				...
				new DriveProfile("/home/lvuser/LR0S.csv")
...
////		addParallel(new OpenClaw());
		addSequential(new DriveProfile("/home/lvuser/LR1S.csv"));
...
//		addSequential(new CloseClaw());
		...
		addSequential(new MakeParallel(
				new MakeSequential(
					...
					new DriveProfile("/home/lvuser/LR2S.csv")

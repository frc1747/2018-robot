...
//	boolean operator;
    ...
    protected void execute() {
    	...
    	angleSetpoint = -a_v_max * Math.max(-1.0, Math.min(1.0, Math.pow(OI.getInstance().getDriver().getAxis(Logitech.RIGHT_HORIZONTAL), 3))); // + 0.5 * OI.getInstance().getOperator().getAxis(Logitech.RIGHT_HORIZONTAL)
